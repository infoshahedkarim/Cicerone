  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div>
          <iframe style="border:0; width: 100%; height: 270px;" src="https://goo.gl/maps/KDcKxXkP5f3AJ5Rc8" frameborder="0" allowfullscreen></iframe>
        </div>
<!-- https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d12097.433213460943!2d-74.0062269!3d40.7101282!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xb89d1fe6bc499443!2sDowntown+Conference+Center!5e0!3m2!1smk!2sbg!4v1539943755621 -->
        <div class="row mt-5">
          ...
          <div class="col-lg-4">
            <div class="info">
              ...
              <div class="email">
                ...
                <h4>Email:</h4>
                <p>info.shahedkarim@gmail.com</p>
              </div>
          ...
          <?php include('message.php'); ?>
            ...
            <form action="database_query.php" method="POST" class="php-email-form">
              <div class="row">
              ...
              <div class="text-center"><button type="submit" name="contact_send_mgs" >Send Message</button></div>
            </form>
