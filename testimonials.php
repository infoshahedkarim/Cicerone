        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="testimonial-item">
              <img src="assets/img/team/shahed11.png" class="testimonial-img" alt="">
              <h3>Shahed Karim</h3>
              <h4>Team &amp; Member</h4>
              <p>
                <i class="bx bxs-quote-alt-left quote-icon-left"></i>
               ID: 20200104019 Email: info.shahedkarim@gmail.com
          ...
          <div class="col-lg-6">
            <div class="testimonial-item mt-4 mt-lg-0">
              <img src="assets/img/team/daliya.jpg" class="testimonial-img" alt="">
              <h3>Daliya</h3>
              <h4>Team Member</h4>
              <p>
                <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                ID: 20200104012 Email: zannatul.cse.200104012@aust.edu
                <i class="bx bxs-quote-alt-right quote-icon-right"></i>
              </p>
            </div>
          </div>
