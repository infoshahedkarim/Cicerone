...
<section id="breadcrumbs" class="breadcrumbs">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url(assets/img/admin-01.png)">
          <div class="carousel-container">
            <div class="container">
              <h1 class="animate__animated animate__fadeInDown display-3 fw-bold text-uppercase"><span style="color:#fff">Admin Panel</span></h1>
            </div>
          </div>
        </div>
  ...
  <div class="carousel-container text-center mt-5 mb-5">
            <div class="container">
              <h1 class="animate__animated animate__fadeInDown display-3 text-uppercase fw-bold">Admin<spam style="color:#d9232d"> Dashboard</spam></h1>
            </div>
          </div>
