        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="assets/img/team/shahed11.png" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Shahed Karim</h4>
                <span>Chief Executive Officer</span>
                <p>AUST CSE Student.</p>
                <div class="social">
          ...
          <div class="col-lg-6 mt-4 mt-lg-0">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="assets/img/team/daliya.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Zannatul Ferdous Daliya</h4>
                <span>Chief Executive Officer</span>
                <p>AUST CSE Student.</p>
                <div class="social">
                  <a href=""><i class="ri-twitter-fill"></i></a>
